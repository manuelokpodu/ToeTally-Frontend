  ...
  return (
    <div className="py-2 font-family-2">
      ...
      <div className="bg-[#01497C] text-[#FFFFFF] text-center mt-2 md:py-2 lg:py-4">
        ...
        >
          {/* Cards */}
          {["6 Years Active", "10,000+ Orders", "8 Stores", "20,000+ Satisfied Customers"].map((item, index) => (
            <div
              key={index}
              className="min-w-[75%] flex-shrink-0 snap-center border-r-[1px] border-[#FFFFFF] lg:min-w-0 flex items-center justify-center mt-2 mb-2"
            >
              <div>
      ...
      <div className="grid md:grid-cols-2 md:py-8">
        <div className="p-3">
      ...
      <div className="flex flex-col justify-center items-center px-4 py-10 md:py-16">
        <h1 className="font-family-3 mx-auto mb-4">Meet The Team</h1>

        <div
          ref={teamCarouselRef}
          className="font-font-family-2 flex items-center gap-4 overflow-x-auto hide-scrollbar md:hidden"
        >
          {[
