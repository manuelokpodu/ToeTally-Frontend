...
const PromoModal = () => {
  ...
  return (
    ...
    <div className="relative top-0 left-0 w-full bg-black text-white text-sm flex items-center justify-center px-4 py-2 h-[35px] mx-auto md:px-6 font-family-2">
